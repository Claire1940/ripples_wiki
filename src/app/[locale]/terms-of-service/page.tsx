...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Ripples Wiki",
    description: "Read the Terms of Service for Ripples Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our itch.io visual novel resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Ripples Wiki",
      description: "Terms and conditions for using Ripples Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Ripples Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Ripples Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Ripples Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Ripples Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the itch.io visual novel "Ripples". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Walkthrough and story guides</li>
              <li>Choice and branching route guides</li>
              <li>Character and route information</li>
              <li>Episode release updates</li>
              <li>Ending and route walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Ripples Wiki is NOT affiliated with, endorsed by, or associated with
              Jestur (itch.io), the creator of Ripples. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Ripples Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Jestur, the creator of Ripples. We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> itch.io demo and game updates may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, RIPPLES WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including itch.io, Discord, social media platforms,
            ...
            <p>
              ...
              you and Ripples Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@ripples.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@ripples.wiki</a>
            </p>
            <p>
