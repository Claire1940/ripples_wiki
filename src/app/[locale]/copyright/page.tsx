...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Ripples Wiki',
    description: 'Copyright and intellectual property information for Ripples Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Ripples Wiki',
      description: 'Copyright and intellectual property information for Ripples Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Ripples Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Ripples Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Ripples Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>itch.io</strong> - Host of the Ripples game page</li>
              <li><strong>Jestur</strong> - Creator and developer of Ripples</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>itch.io</strong> - Game distribution platform</li>
              <li><strong>Ripples</strong> - Game by Jestur</li>
              <li><strong>Ripples Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
            ...
            <p>
              ...
              Ripples Wiki<br />
              Email: <a href="mailto:dmca@ripples.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@ripples.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Ripples Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Ripples Wiki (ripples.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@ripples.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@ripples.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@ripples.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@ripples.wiki</a>
            </p>
            <p>
